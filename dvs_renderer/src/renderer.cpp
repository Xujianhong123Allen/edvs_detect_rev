    ...
    image_tracking_(nh)
{
  ...
  event_sub_ = nh_.subscribe("/edvs/event_array", 1, &Renderer::eventsCallback, this);
  camera_info_sub_ = nh_.subscribe("/edvs/camera_info", 1, &Renderer::cameraInfoCallback, this);
